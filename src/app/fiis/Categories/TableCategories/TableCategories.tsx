      ...
      <Table className="min-w-full table-auto">
        <TableHeader>
          <TableRow className="border-primary/40">
            <TableHead className="px-0 py-4 text-sm font-semibold text-primary-t/80">FII</TableHead>
            <TableHead className="px-0 py-4 text-sm font-semibold text-primary-t/80">Valor de Mercado</TableHead>
            ...
            <TableHead className="px-0 py-4 text-sm font-semibold text-primary-t/80">P/Vp</TableHead>
          </TableRow>
        </TableHeader>
        <tbody>
            ...
            <>
              {data.content
                ...
                .map((fii, index) => (
                  ...
                  >
                    <td className="py-4 text-sm font-medium text-primary-t">{fii.paper}</td>
                    <td className="py-4 text-sm text-primary-t">{formatMarketCap(fii.marketValue)}</td>
                    <td className="py-4 text-sm text-primary-t">{fii.dividend}</td>
                    <td className="py-4 text-sm text-primary-t">{fii.ffO}</td>
                    <td className="py-4 text-sm text-primary-t">{fii.pVp}</td>
                  </TableRow>
                ))}
            </>
          ) : (
