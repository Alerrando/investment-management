  ...
  return (
    <div className="flex h-auto flex-col gap-8 border px-8 py-8">
      ...
      <div className="flex gap-2">
        <div
          className={`cursor-pointer rounded-lg ${order === "categories" ? "bg-primary text-foreground" : "text-primary"} p-2`}
        ...
        <div
          className={`cursor-pointer rounded-lg ${order === "list" ? "bg-primary text-foreground" : "text-primary"} p-2`}
